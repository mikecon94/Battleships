...
/**
 * A helper class with some static methods which will be used
 * by some of the View objects. We also store the height & the
...
public class UIHelper {
	...
	/**
	 * Resizes a given image to a given width & height. Used for the background, icons
	 * and button images etc.
